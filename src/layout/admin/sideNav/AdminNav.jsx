                ...
                <div className="flex items-center p-2 space-x-4">
                    ...
                    <div>
                        ...
                        <span className="flex items-center space-x-1 flex-wrap">
                            <a rel="noopener noreferrer" href="#" className="text-xs hover:underline text-gray-600">{user?.email}</a>
                        </span>
                    </div>
                </div>
                <div className="divide-y divide-gray-300">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        <Link to={'admin_dash_page'}>
                            <li className=" rounded hover:bg-purple-300 text-gray-900">
                        ...
                        <Link to={'admin_reviews'}>
                            <li>
                                <p className=" hover:bg-purple-300 flex items-center p-2 space-x-3 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                    ...
                    <ul className="pt-4 pb-2 space-y-1 text-sm">
                        ...
                        <li>
                            <a className="flex items-center p-2 space-x-3 rounded-md hover:bg-purple-300">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
